...
public class HeldKarp_Implementation {
    ...
    private static void TravellingSalesmsn(int[][] graph, int n) {
        ...
        */
        ...
        for (int i = 2; i <= n; i++) {
            ...
            s.add(i);
            // System.out.println(Distance(graph, 1, i));
        ...
        for (k = 2; k <= n - 1; k++) {
            ...
            while (set_iterator.hasNext()) {
                ...
                while (element_iterator.hasNext()) {
                    ...
                    // System.out.println(sub_solutions.get(sub_solutions.size() - 1).cities);
                }
            }
    ...
    @SuppressWarnings("unchecked")
    private static HeldKarp_SubSolution ComputeBestSubset(int x, HashSet<Integer> s,
            ArrayList<HeldKarp_SubSolution> sub_solutions, int[][] graph) {
